...
- 🐦‍⬛ **[karasufumi](https://github.com/apoorvdarshan/karasufumi)** *(closed source)* - Automate your job hunt with Claude Code or Codex — cold outreach via Gmail MCP, tracked in a single JSON file
