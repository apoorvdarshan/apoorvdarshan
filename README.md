...
- 🐍 **[boa](https://github.com/boa-dev/boa/pull/4621)** ![Stars](https://img.shields.io/github/stars/boa-dev/boa?v=2&style=flat-square&label=★&color=0D7C37) - feat: implement BOM stripping and ignoreBOM option in TextDecoder
...
- 📺 **[ccextractor](https://github.com/CCExtractor/ccextractor/pull/2136)** ![Stars](https://img.shields.io/github/stars/CCExtractor/ccextractor?v=2&style=flat-square&label=★&color=0D7C37) - fix: config file parsing bugs and typos
