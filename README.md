...
<ul>
  ...
  <li>
    <details>
      ...
      <div>&bull; ❄️ <strong><a href="https://github.com/sqlfluff/sqlfluff/pulls?q=author%3Aapoorvdarshan">sqlfluff</a></strong> <img alt="Stars" src="https://github-star-badge.apoorvdarshan.workers.dev/api/stars?repo=sqlfluff/sqlfluff"> - 5 merged PRs: WITH TAG in Snowflake CREATE TASK + ClickHouse ORDER BY ... WITH FILL ... INTERPOLATE + Oracle FOR UPDATE ... NOWAIT / WAIT n / SKIP LOCKED + ClickHouse ORDER BY / LIMIT / SETTINGS on non-final union members + ClickHouse multi-column LIMIT n BY a, b</div>
